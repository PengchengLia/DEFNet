...
class EnvSettings_ITP:
    def __init__(self, workspace_dir, data_dir, save_dir):
        ...
        self.gtot_path = "/data1/Datasets/Tracking/GTOT/"
        self.rgbt210_path = "/data1/Datasets/Tracking/RGBT210/"
        self.rgbt234_path = "/data1/Datasets/Tracking/RGBT234/"
        self.lasher_path = "/data1/Datasets/Tracking/LasHeR/"
